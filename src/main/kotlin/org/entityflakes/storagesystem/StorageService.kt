...
import org.entityflakes.processor.UpdatingProcessorBase
...
class StorageService(val saveFile: File = File("world_save.bin"),
                     updateIntervalSeconds: Double = 10.0 * 60.0): UpdatingProcessorBase(FixedTimestepStrategy(updateIntervalSeconds)) {
